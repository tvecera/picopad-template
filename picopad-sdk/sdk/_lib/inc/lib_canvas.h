...
//       B4 .  |  . B7
//         . B5|B6 .
void DrawFillCircle(sCanvas* canvas, int x0, int y0, int r, u8 col, u8 mask);
...
//       B4 .  |  . B7
//         . B5|B6 .
void DrawCircle(sCanvas* canvas, int x0, int y0, int r, u8 col, u8 mask);
...
//   font = pointer to 1-bit font, font width < 8 pixels
void DrawSmallText(sCanvas* canvas, const char* text, int x, int y, u8 col,
...
//   font = pointer to 1-bit font, font width < 8 pixels
void DrawSmallTextBg(sCanvas* canvas, const char* text, int x, int y, u8 col, u8 bgcol,
	const void* font, int fontheight, int fontwidth);
